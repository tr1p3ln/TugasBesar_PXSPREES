<x-app-layout>
    ...
    <div class="mt-16">
        ...
        <section class="bg-contain bg-center bg-no-repeat bg-[url('https://images.pexels.com/photos/7773720/pexels-photo-7773720.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')] ">
            <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                ...
                <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                    <a href="{{ route('booking') }}" class="px-6 py-3 bg-purple-600 text-white rounded-xl hover:bg-purple-700 transition">Booking</a>
                </div>
            </div>
        </section>
        ...
        <!-- Location section -->
        <div class="location-section bg-black py-12 px-4 sm:px-6 lg:px-8">
