            ...
            <div class="bg-gray-800/50 backdrop-blur-sm overflow-hidden shadow-xl sm:rounded-lg p-6 md:p-8">
                    ...
                    @if (!$payment->payment_proof)
                        ...
                        <div class="mb-8">
                            ...
                            <div class="flex justify-center gap-4 mb-6">
                                <button id="btn-transfer" class="px-6 py-2 font-bold rounded-lg bg-purple-600 hover:bg-purple-700 transition">
                                    Transfer Bank
                                </button>
                                <button id="btn-qr" class="px-6 py-2 font-bold rounded-lg bg-gray-600 hover:bg-gray-500 transition">
                                    QR Code
                                </button>
                            </div>
                            ...
                            <div class="bg-gray-900/70 p-6 rounded-lg border border-gray-700 min-h-[180px]">
                                ...
                                <div id="info-transfer">
                                    ...
                                    <div class="space-y-2 p-4 bg-gray-800 rounded-lg text-sm">
                                        ...
                                        <p><span class="font-bold">Mandiri:</span> 098-765-4321 (a.n. PSXPRESS INDONESIA)</p>
                                    </div>
                                </div>
                                ...
                                <div id="info-qr" class="hidden text-center">
                                    ...
                                    <p class="text-gray-400 mb-4">Gunakan aplikasi e-wallet atau m-banking Anda untuk scan.</p>
                                    <div class="mt-2 p-2 bg-white rounded-lg inline-block">
                                        <!-- qr image-->
                                        <img src="{{ asset('assets/picture/qr.jpg') }}" alt="QR Code Pembayaran" class="mx-auto h-40 w-40">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <form action="{{ route('payment.upload', $payment->id) }}" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto">
                                ...
                                <div class="mb-6">
                                    ...
                                    <div class="flex items-center justify-center w-full">
                                        <label for="payment_proof" id="file-upload-label" class="flex flex-col w-full h-32 border-2 border-dashed border-gray-600 hover:border-purple-500 rounded-lg cursor-pointer bg-gray-900/50 hover:bg-gray-900/70 transition">
                                            <div id="upload-prompt" class="flex flex-col items-center justify-center pt-7">
                                            ...
                                            <div id="file-name-display" class="hidden text-center text-purple-400 font-semibold self-center"></div>
                ...
                @else
                    ...
                    <div class="text-center bg-red-900/50 border border-red-700 p-6 rounded-lg">
                        ...
                        <a href="{{ route('booking') }}" class="mt-4 inline-block px-4 py-2 bg-purple-600 rounded-lg hover:bg-purple-700 transition">
                            Buat Booking Baru
                        </a>
                    </div>
                @endif
